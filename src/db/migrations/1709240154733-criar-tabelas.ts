...
export class CriarTabelas1709240154733 implements MigrationInterface {
	name = 'CriarTabelas1709240154733';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`CREATE TABLE "estacionamentos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "usuario_id" character varying(100) NOT NULL, "nome" character varying(150) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_f52c7720f1dbae3540f26f2659c" PRIMARY KEY ("id"))`);
